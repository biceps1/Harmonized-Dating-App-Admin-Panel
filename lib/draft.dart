...
//                                     "${reportsController.allReports.length}"),
//                                 _buildStatCard("Pending Cases",
//                                     "${reportsController.allReports.where((e) => e.status == "Pending").toList().length}"),
//                                 _buildStatCard("Resolved Cases",
//                                     "${reportsController.allReports.where((e) => e.status == "Resolved").toList().length}"),
//                               ],
//                             ),
//                           );
//                         } else {
